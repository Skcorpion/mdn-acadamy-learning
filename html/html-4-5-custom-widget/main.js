...
/* Add the support of forEach to NodeList (Array support forEach, 
    NodeList not) - querySelectorAll returne nodeList, not Array */
...
/* As seen previously, we already use a native select widget as a fallback 
for accessibility reasons; we can simply synchronize its value with that of our custom widget: */
